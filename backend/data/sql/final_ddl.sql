-- ============================================================
-- SAFE INIT (ไม่ DROP ถ้ามีอยู่แล้ว)
-- ============================================================
...
-- 1. โครงสร้างองค์กร
-- ============================================================
CREATE TABLE IF NOT EXISTS SetCompany (
    ScpCode  CHAR(6)      PRIMARY KEY,
    ScpName  VARCHAR(20)  NOT NULL
);

CREATE TABLE IF NOT EXISTS SetDepartment (
...
CREATE OR REPLACE TRIGGER setEmployeeBirthday
...
CREATE OR REPLACE TRIGGER setEmployeeWorkStatus
...
CREATE OR REPLACE TRIGGER fillDeptCompanyName
